...
use Werkint\Bundle\SpritesBundle\Service\Event\TileProcessEvent;
use Werkint\Bundle\SpritesBundle\Service\TwigExtension;
use Werkint\Bundle\SpritesBundle\WerkintSpritesBundle;

/**
 * TileProcessEventTest.
 *
 * @author Bogdan Yurov <bogdan@yurov.me>
 */
class TileProcessEventTest extends \PHPUnit_Framework_TestCase
{
    public function testClass()
    {
        ...
        $this->assertEquals($var3, $obj->getTileName());
    }
